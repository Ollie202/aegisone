...
ProofRail's core value is independently checkable evidence. Introducing probabilistic model judgment into the correspondence verdict weakens that property and incorrectly turns the product into a malware/code-quality auditor.
