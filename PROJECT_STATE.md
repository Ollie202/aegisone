...
Review and merge **PR 4/4** (`feature/for-agents` → `main`) with green CI. This merge brings PR 1-4
of the four-section-IA restructure into `main` together, since PR 1-3 were each merged into the
next feature branch in the chain rather than into `main` directly. Do not perform a live 0G run as
