...
const FIXTURES: readonly FixtureDefinition[] = [
  {
    ...
    resourceUrl: "https://catalog.aegisone.example/skills/pull-request-reviewer",
    version: "1.0.0",
  ...
  },
  {
    ...
    identifier: "urn:air:aegisone.example:mcp:weather-observer",
    kind: "mcp-server",
    ...
    resourceUrl: "https://catalog.aegisone.example/mcp/weather-observer.json",
    version: "1.0.0",
  ...
  },
  {
    ...
    identifier: "urn:air:aegisone.example:a2a:travel-planner",
    kind: "a2a-agent",
    name: "Travel Planning A2A Agent",
    description: "Builds travel itineraries and coordinates flight and accommodation research.",
    resourceUrl: "https://catalog.aegisone.example/a2a/travel-planner.json",
    version: "1.0.0",
  ...
  },
  {
    ...
    identifier: "urn:air:aegisone.example:api:invoice-extraction",
    kind: "api",
    name: "Invoice Extraction API",
    description: "Extracts structured invoice fields through a documented OpenAPI interface.",
    resourceUrl: "https://catalog.aegisone.example/apis/invoice-extraction.openapi.json",
    version: "1.0.0",
