 ...
 * Endpoint: `POST https://huggingface-hf-discover.hf.space/search`. Public search only; ProofRail
 ...
 * registry). ProofRail only consumes `results`; referrals are discovery pointers, not resources,
